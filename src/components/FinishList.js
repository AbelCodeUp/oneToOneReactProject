...
class FinishList extends React.Component {
  ...
  YueKeNoNext1(LessonState, AttendLessonID) {
    ...
    let arr = [];
    if (LessonState < 1440) {
      axios.get(ServerUrl.CancelLessonCount).then(function(response) {
            ...
            ? <div>
                {
                  LessonRecords.length === 0
                    ...
                    : LessonRecords.map((data, index) => (<div className="smy_course_unfinish_list_box">
                      <div key={index} className="smy_course_unfinish_list_item">
                        ...
                        <div className="smy_course_unfinish_list_item_middle">
                          ...
                          <div className="smy_course_unfinish_list_item_imgRight">
                            <div className="smy_course_unfinish_list_item_courseTitle">
                              <span className="smy_course_unfinish_list_item_courseTitleRel">{data.BookName}&#x3000;{data.LessonType}</span>
                              <span className="smy_course_unfinish_tiyan">{/* data.LessonType */}</span>
                            </div>
                            {/* <!-- 关注状态 --> */}
                            <div className="smy_course_unfinish_list_item_imgRightBot">
                              <div className="smy_course_unfinish_list_item_teacherName">{data.EnglishName}&#x3000;</div>
                              <div className="smy_course_unfinish_list_item_follow"><img ref="guanzhuImg" src={data.AttentionStatus == 1
                        ? "../images/smy_course_uf_follow2.png"
                        : "../images/smy_course_uf_follow1.png"
}/>
                              </div>
                            </div>
                          </div>
                        ...
                        {
                          data.Status == 1
                            ? <button className="smy_course_unfinish_list_item_button_hong" onClick={this.quXiaoYuYue.bind(this, index, data.LessonState, data.AttendLessonID)}>
                                取消预约</button>
                        ...
                        {/* <!-- 正在上课 --> */}
                        {
                          data.LessonState < 10
                            ? data.LessonState < 0 && data.LessonState < (-30)
                              ? <div className="smy_course_unfinish_list_item_state">
                                  <span>正在上课</span><img src={require('../images/smy_course_uf_state1.png')}/>
                                </div>
                              : <div className="smy_course_unfinish_list_item_state2">
                                  <span>即将开课</span><img src="../images/smy_course_uf_state2.png"/>
                                </div>
                            : null
                        }
                ...
                {
                  this.state.time === 2
                    ? <YueKeNoNext YueKeNoNext1={this.YueKeNoNext1.bind(this, this.state.LessonState, this.state.AttendLessonID)} YueKeNoNext2={this.YueKeNoNext2.bind(this)}/>
                    : this.state.time === 3
                      ? <YueKeNoNext2 LessonRecords3={this.state.LessonRecords3} YueKeNoNext3={this.YueKeNoNext2.bind(this)} YueKeNoNext4={this.YueKeNoNext4.bind(this, this.state.AttendLessonID)}/>
                      : null
                }
              </div>
            : <div className="smy_course_finished_list_box">
                {
                  LessonRecords2.length === 0
                    ...
                    : LessonRecords2.map((data, index) => (<div key={index} className="smy_course_finished_list_item">
                      ...
                      <div className="smy_course_finished_list_item_middle">
                        ...
                        <div className="smy_course_finished_list_item_imgRight">
                          <div className="smy_course_finished_list_item_courseTitle">
                            <span className="smy_course_finished_list_item_courseTitleRel">{data.BookName}&#x3000;{data.LessonType}</span>
                            <span className="smy_course_finished_tiyan">{/* data.LessonType */}</span>
                          </div>
                          {/* <!-- 关注状态 --> */}
                          <div className="smy_course_finished_list_item_imgRightBot">
                            ...
                            <div className="smy_course_finished_list_item_follow"><img src={data.AttentionStatus == 1
                        ? "../images/smy_course_uf_follow2.png"
                        : "../images/smy_course_uf_follow1.png"}/>
                            </div>
                          </div>
                      ...
                      <div className="smy_course_finished_list_item_bottom">
                        ...
                        <div className="smy_course_finished_list_item_xing">
                          {
                            this.state.xXing.map((data2, index) => (<img key={index} src={index < (data.TCommentPoint - 1)
                                ? "../images/smy_course_dp_xing1.png"
                                : "../images/smy_course_dp_xing2.png"} alt="" className="smy_course_finished_list_item_xing_img"/>))
                          }
                        </div>
                        <div className="smy_course_finished_list_item_trophy"><img src="../images/smy_course_fini_bei.png" alt="" className="smy_course_finished_list_item_trophyImg"/>
                          <span className="smy_course_finished_list_item_trophyText">×{data.Gift}</span>
                        </div>
                        {
                          data.IsComment === 0
                            ? <Link to={{
                      ...
                      {/* <!-- 外教缺席 --> */}
                      <div className="smy_course_finished_list_item_state">
                        <span>{data.WorkAttendance}</span>
                      </div>
                    </div>))
                }
